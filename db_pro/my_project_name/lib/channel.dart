...
class MyProjectNameChannel extends ApplicationChannel {
  ...
  Future prepare() async {
    ...
    final config = MyProjectNameConfiguration(options.configurationFilePath);
...
class MyProjectNameConfiguration extends Configuration {
  MyProjectNameConfiguration(String fileName) : super.fromFile(File(fileName));
